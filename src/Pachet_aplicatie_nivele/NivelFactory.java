...
public class NivelFactory {
	...
	public static void creazaScena(String tipScena,Pane root,double width, double height) {
		...
		if(tipScena.equalsIgnoreCase("Config")) {
			...
			tipScenaDorit = Build_ConfigAPP.setting( root, width,  height);
			...
			tipScenaDorit = Build_InfoAPP.setting( root, width,  height);
			...
			tipScenaDorit = Build_IntroAPP.setting( root, width,  height);
			...
			tipScenaDorit = Build_Nivel01.setting(root, width,  height);
			...
			tipScenaDorit = Build_Nivel02.setting(root, width,  height);
